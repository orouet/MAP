 ...
 * @return boolean
 */
function mdp_debug($variable, $message = '')
{
...
/**
 * Génération aléatoire d'un entier entre min et max
 * @param integer $min
 * @param integer $max
...
/**
 * Tire un caractère dans un dictionnaire (chaine)
 * @param string $dictionnaire
 * @return false|string
 */
 ...
 * @param integer $majuscules_min
 * @param integer $minuscules_min
 * @param integer $chiffres_min
 * @param integer $speciaux_min
